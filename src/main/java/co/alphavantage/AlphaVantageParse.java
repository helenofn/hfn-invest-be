...
public abstract class AlphaVantageParse<T> {

	/**
	 * Different formats to help child responses to interpret different dates in
	 * json
	 */
	...
	/**
	 * The logic the helper for the response need to implement in order to interpret
	 * the json correctly.
	 *
